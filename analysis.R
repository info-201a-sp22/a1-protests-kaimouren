...
#Data, Location, Attendance, Event...legacy..see.tags, Tages, Curated, Source, Total.Articles
...
#2017-01-16, Indianapolis, IN, 20, Environment, Environment; For wilderness preservation, 	Yes, http://wishtv.com/2017/01/16/nature-groups-protest-defores, 1
...
num-features <- ncol(protest_data)
## Part 2: Attendees ------------------------------------------------------
...
prop_in_wa <- num_in_wa/num_location
